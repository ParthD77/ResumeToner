          ...
          <section className="panel onboarding-card">
            ...
            <label className="check">
              <input
                ...
                checked={checks[0]}
                onChange={(e) =>
                  setChecks([e.target.checked, checks[1], checks[2], checks[3]])
                }
              />
            ...
            <label className="check">
              <input
                ...
                checked={checks[1]}
                onChange={(e) =>
                  setChecks([checks[0], e.target.checked, checks[2], checks[3]])
                }
              />
            ...
            <label className="check">
              <input
                ...
                checked={checks[2]}
                onChange={(e) =>
                  setChecks([checks[0], checks[1], e.target.checked, checks[3]])
                }
              />
            ...
            <label className="check">
              <input
                ...
                checked={checks[3]}
                onChange={(e) =>
                  setChecks([checks[0], checks[1], checks[2], e.target.checked])
                }
              />
              I am at least 18 years old. If I am in the EEA, Switzerland, or
              the United Kingdom, I will use a Gemini API key connected to a
              Cloud project with active billing, as required by Google&apos;s
              current Gemini API terms.
            </label>
            <details className="legal-details">
              ...
              <p>
                See the complete <a href="https://github.com/ParthD77/ResumeToner/blob/main/TERMS.md">Terms of Use</a>.
              </p>
            </details>
      ...
      <div className="settings-grid">
        ...
        <section className="panel">
          ...
          <label className="check">
            <input
              type="checkbox"
              checked={settings.termsVersion >= TERMS_VERSION}
              onChange={(event) =>
                void saveSettings({
                  ...settings,
                  termsVersion: event.target.checked ? TERMS_VERSION : 0,
                })
              }
            />
            I am at least 18 years old, will verify generated content, and
            accept the current Terms of Use. If I am in the EEA, Switzerland,
            or the United Kingdom, I will use a Gemini key connected to a Cloud
            project with active billing.
          </label>
          <p>
            <a href="https://github.com/ParthD77/ResumeToner/blob/main/TERMS.md">Read the complete Terms of Use</a>.
          </p>
          <label className="check">
            <input
              type="checkbox"
