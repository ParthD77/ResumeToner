...
describe("compatible resume import", () => {
  ...
  it("removes quote-bearing ChatGPT citation markers before parsing JSON", () => {
    const parsed = extractJsonFromChat(
      String.raw`{"summary":"Eligible. :chatgpt-content-reference{index="0"}","sourceUrl":"https://example.com/job"}`,
    );
