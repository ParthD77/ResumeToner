...
export const SessionSchema = z.object({
  ...
  reviews: z.record(ReviewSchema), recoveryReviews: z.record(ReviewSchema).default({}), sideOpen: z.boolean(),
...
export function emptySession(base = ""): Session {
  return { savedBase: base, base, latexInput: "", job: "", responseText: "", result: null, reviews: {}, recoveryReviews: {}, sideOpen: true };
}
